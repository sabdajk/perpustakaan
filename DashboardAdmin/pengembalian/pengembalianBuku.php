    ...
    <table class="table table-striped table-hover">
     <thead class="text-center">
      ...
      <tr>
        ...
        <td>
          <div class="action">
            <button class="btn btn-danger delete-btn" data-id="<?= $item["id_pengembalian"]; ?>"><i class="fa-solid fa-trash"></i></button>
          </div>
        </td>
      </tr>
        <?php endforeach; ?>
      ...
      button.addEventListener('click', function(e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = `deletePengembalian.php?id=${id}`;
          }
        });
      });
    });
