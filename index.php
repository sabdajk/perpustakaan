      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 team-member" data-aos="fade-up">
            ...
            <h4 style="padding-top: 15px;">Gibran Al Imrani</h4>
            <p>Mahasiswa T. Industri</p>
          ...
          <div class="col-md-3 team-member" data-aos="fade-up">
            <img src="assets/profil/dara.jpg" alt="Theresa Bell">
            <h4 style="padding-top: 15px;">Dara Safitri</h4>
            <p>Mahasiswa T. Industri</p>
            <div class="social-icons">
              <a href="#"><i class="fa-brands fa-instagram"></i></a>
              <a href="#"><i class="fa-brands fa-facebook"></i></a>
          ...
          <div class="col-md-3 team-member" data-aos="fade-up">
            <img src="assets/profil/aeroh.jpg" alt="Darrell Steward">
            <h4 style="padding-top: 15px;">Aerohman</h4>
            <p>Mahasiswa T. Industri</p>
            <div class="social-icons">
              <a href="#"><i class="fa-brands fa-instagram"></i></a>
              <a href="#"><i class="fa-brands fa-facebook"></i></a>
          ...
          <div class="col-md-3 team-member" data-aos="fade-up">
            <img src="assets/profil/sabda.jpg" alt="Fiony Alveria">
            <h4 style="padding-top: 15px;">Sabda Prathama</h4>
            <p>Mahasiswa T. Industri</p>
            <div class="social-icons">
              <a href="#"><i class="fa-brands fa-instagram"></i></a>
              <a href="#"><i class="fa-brands fa-facebook"></i></a>
