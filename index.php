  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">perpustakaan</h2>
          <p class="mb-4">"akses pengetahuan bisa melalui layar pandang anda: <br> Perpustakaan Online <span class="text-primary">Perpustakaan</span> Membawa Anda ke Dunia Buku Digital."</p>
          <a class="btn btn-primary" href="sign/link_login.html">Mulaikan</a>
        </div>
        <div class="col mt-3">
          <img src="assets/dasboardbaru.png" width="450px">
        </div>
      </div>
    </section>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      <div class="row">
          ...
          <div class= "justify-content-centered">
            <div class= "text" >Kami percaya bahwa pengetahuan adalah kekuatan, dan setiap individu berhak mendapatkan akses ke sumber daya pendidikan yang berkualitas. 
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title-justify">Teknik Industri Universitas Muhammadiyah Cirebon</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Kelompok 1 Teknik Industri</a>  2024</p>
        </div>
      </div>
    </footer>
