        ...
        <form action="" method="post">
            ...
            <div class="d-flex flex-wrap gap-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="tgl_pengembalian" id="tgl_pengembalian" value="<?= $item["tgl_pengembalian"]; ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Hari Pengembalian Buku</label>
                    <input type="date" class="form-control" name="buku_kembali" id="buku_kembali" value="<?php echo date('Y-m-d');?>">
                </div>
            </div>
            <?php endforeach; ?>
            ...
            <div class="d-flex flex-wrap gap-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="keterlambatan" id="keterlambatan" readonly>
                </div>
                <div class="mb-3">
